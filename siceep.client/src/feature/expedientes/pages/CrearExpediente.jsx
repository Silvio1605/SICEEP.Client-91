        ...
        <Box sx={{ width: '100%', pb: 5 }}>
            ...
            <Paper elevation={2} sx={{ width: '100%', borderRadius: 2 }}>
                <Box sx={{ borderBottom: 1, borderColor: 'divider', backgroundColor: '#f8f9fa', borderRadius: '8px 8px 0 0' }}>
                    <Tabs value={tabActiva} onChange={handleChangeTab} variant="scrollable" scrollButtons="auto" allowScrollButtonsMobile>
                        ...
                        <Tab label="3 - Prep. Académica" />
                        <Tab label="4 - Características" />
                        <Tab label="5 - Núcleo Familiar" />
                ...
                <CustomTabPanel value={tabActiva} index={2}><TabInfoAcademica /></CustomTabPanel>
                <CustomTabPanel value={tabActiva} index={3}><TabCaracteristicas /></CustomTabPanel>
                <CustomTabPanel value={tabActiva} index={4}><TabNucleofamiliar /></CustomTabPanel>
            ...
            <Dialog open={modalValidacion} onClose={cerrarValidacion} maxWidth="sm" fullWidth>
                ...
                <DialogContent>
                    ...
                    <List dense>
                        <ListItem><ListItemIcon sx={{ minWidth: 35 }}><CheckCircleIcon color="success" fontSize="small" /></ListItemIcon><ListItemText primary="Datos Generales (Nombres, Cédula)" /></ListItem>
                        {/* Se actualizó este texto para reflejar la fusión */}
                        <ListItem><ListItemIcon sx={{ minWidth: 35 }}><CheckCircleIcon color="success" fontSize="small" /></ListItemIcon><ListItemText primary="Ubicación y Plaza (Info. Laboral)" /></ListItem>
                    </List>
                    ...
                    <List dense>
                        <ListItem><ListItemIcon sx={{ minWidth: 35 }}><WarningAmberIcon color="warning" fontSize="small" /></ListItemIcon><ListItemText primary="Pestaña 2: Salario Devengado." /></ListItem>
                        <ListItem><ListItemIcon sx={{ minWidth: 35 }}><WarningAmberIcon color="warning" fontSize="small" /></ListItemIcon><ListItemText primary="Pestaña 6: Fotografía y Cédula." /></ListItem>
                    </List>
                </DialogContent>
